...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-02 21:35`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/884184c7-02f7-442a-b4e6-b2b19821d7e0.git
$ cd 884184c7-02f7-442a-b4e6-b2b19821d7e0
```
